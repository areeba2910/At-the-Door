...
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'support@migrateshop.com', 'domestic cleaning', '4887handyman-logo.png', '9804favicon.png', 'Domestic Cleaning tutorials', 'HTML,CSS,XML,JavaScript', 'http://localhost/handyman/', 'info@codexworld.com', 'USD', 'test');
...
--
-- Indexes for table `sv_city`
--
ALTER TABLE `sv_city`
  ADD PRIMARY KEY (`city_id`);

--
-- Indexes for table `sv_contact`
--
ALTER TABLE `sv_contact`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `sv_pages`
--
ALTER TABLE `sv_pages`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `sv_services`
--
ALTER TABLE `sv_services`
  ADD PRIMARY KEY (`services_id`);

--
-- Indexes for table `sv_services_sub`
--
ALTER TABLE `sv_services_sub`
  ADD PRIMARY KEY (`sid`);

--
-- Indexes for table `sv_service_provider`
--
ALTER TABLE `sv_service_provider`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `sv_user_order`
--
ALTER TABLE `sv_user_order`
  ADD PRIMARY KEY (`order_id`);

--
-- Indexes for table `sv_user_profile`
--
...
--
-- AUTO_INCREMENT for table `sv_city`
--
ALTER TABLE `sv_city`
  MODIFY `city_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `sv_contact`
--
ALTER TABLE `sv_contact`
  MODIFY `id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `sv_pages`
--
ALTER TABLE `sv_pages`
  MODIFY `id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `sv_services`
--
ALTER TABLE `sv_services`
  MODIFY `services_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `sv_services_sub`
--
ALTER TABLE `sv_services_sub`
  MODIFY `sid` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `sv_service_provider`
--
ALTER TABLE `sv_service_provider`
  MODIFY `id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `sv_user_order`
--
ALTER TABLE `sv_user_order`
  MODIFY `order_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `sv_user_profile`
--
ALTER TABLE `sv_user_profile`
  MODIFY `signup_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
COMMIT;
